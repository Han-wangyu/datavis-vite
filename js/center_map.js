...
var uploadedDataURL = '../data/data-1528971808162-BkOXf61WX.json';

// 可视化配色
//线条的汇集点坐标
// 32.202397,118.716528
// var geoGpsMap = [106.561312, 29.574336];
var geoGpsMap = [118.716528, 32.202397];
var t = 1; //流入流出控制
var r = 1; //右侧流入流出文字控制
var geoCoordMap = {
    江苏: [118.8062, 31.9208],
...
$(function () {
    ...
    $.getJSON(uploadedDataURL, function (geoJson) {
        ...
        for (var n = 0; n < year.length; n++) {
            var statistic_name = '各省' + (r == 1 ? '入' : '出') + '交通量';
