var rightChart = echarts.init(document.getElementById("right1"));
...
var indicator = [
    { name: '闯红灯', max: 100, num: 1 },
    { name: '超速', max: 100, num: 2 },
    { name: '逆行', max: 100, num: 3 },
    { name: '违停', max: 100, num: 4 },
    { name: '闯禁行', max: 100, num: 5 },
];
...
var num = dataValue.reduce(function (prev, cur) {
    return prev + cur;
}, 0);
var option = {
